...
!function (a) {
    ...
    b = wpNavMenu = {
        ...
        init: function () {
            ...
            menus.oneThemeLocationNoMenus && a("#posttype-page").addSelectedToMenu(b.addMenuItemToBottom),
            ...
            a.fn.extend({
                ...
                updateParentMenuItemDBId: function () {
                    ...
                    return this.each(function () {
                        ...
                        c.val(0 === d ? null : f.find(".menu-item-data-db-id").val())
                    })
                },
        ...
        refreshAdvancedAccessibility: function () {
            a(".menu-item-settings .field-move a").css("display", "none"), a(".item-edit").each(function () {
                var b, c, d, e, f, g, h, i, j, z, k = a(this),
