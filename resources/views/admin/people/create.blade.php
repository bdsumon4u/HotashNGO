<x-app-layout>
    ...
    <div class="max-w-3xl mx-auto my-5 bg-white p-3 shadow">
        <H:form :action="route('admin.slides.store')" method="POST" multipart>
            ...
            <div class="flex flex-wrap">
                <div class="pt-7 pb-2 px-4 bg-white border shadow-md relative rounded-md w-full mt-5">
                    ...
                    <H:input name="title" wire:model.defer="title" class="block w-full px-2 py-1 border rounded-md text-gray-700 bg-gray-100 appearance-none focus:outline-none focus:bg-gray-200 focus:shadow-inner" />
            ...
            <div class="flex flex-wrap">
                <div class="pt-7 pb-2 px-4 bg-white border shadow-md relative rounded-md w-full mt-5">
                    ...
                    <H:input name="text" wire:model.defer="text" class="block w-full px-2 py-1 border rounded-md text-gray-700 bg-gray-100 appearance-none focus:outline-none focus:bg-gray-200 focus:shadow-inner" />
