<x-app-layout>
    ...
    <div class="max-w-3xl mx-auto my-5 bg-white p-3 shadow">
        <H:form :action="route('admin.slides.update', $slide)" method="PATCH" multipart>
            ...
            <div class="flex flex-wrap">
                <div class="pt-7 pb-2 px-4 bg-white border shadow-md relative rounded-md w-full mt-5">
                    <h2 class="flex bg-white border py-1 px-2 rounded-md absolute left-0 -top-3">
                        <H:label class="text-sm font-bold" name="title" />
                    </h2>
                    <H:input name="title" wire:model.defer="title" :value="$slide->getCustomProperty('title')" class="block w-full px-2 py-1 border rounded-md text-gray-700 bg-gray-100 appearance-none focus:outline-none focus:bg-gray-200 focus:shadow-inner" />
                    <H:error class="text-red-500" name="title" />
                </div>
            </div>
            <div class="flex flex-wrap">
                <div class="pt-7 pb-2 px-4 bg-white border shadow-md relative rounded-md w-full mt-5">
                    <h2 class="flex bg-white border py-1 px-2 rounded-md absolute left-0 -top-3">
                        <H:label class="text-sm font-bold" name="text" />
                    </h2>
                    <H:input name="text" wire:model.defer="text" :value="$slide->getCustomProperty('text')" class="block w-full px-2 py-1 border rounded-md text-gray-700 bg-gray-100 appearance-none focus:outline-none focus:bg-gray-200 focus:shadow-inner" />
                    <H:error class="text-red-500" name="text" />
                </div>
            </div>
