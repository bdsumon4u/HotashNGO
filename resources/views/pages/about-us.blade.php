    ...
    <div class="about-area pt-100 pb-70">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="about-img">
                        <img src="{{ asset('findo/img/about/about-main1.jpg') }}" alt="About">
                    </div>
                </div>
                <div class="col-lg-6">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-6 col-lg-4">
                    <div class="team-item">
                        <div class="top">
                            <img src="{{ asset('findo/img/team/team1.jpg') }}" alt="Team">
                            <ul>
                                <li>
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="team-item">
                        <div class="top">
                            <img src="{{ asset('findo/img/team/team2.jpg') }}" alt="Team">
                            <ul>
                                <li>
                                    <a href="#" target="_blank">
                                        <i class="icofont-facebook"></i>
                ...
                <div class="col-sm-6 offset-sm-3 offset-lg-0 col-lg-4">
                    <div class="team-item">
                        <div class="top">
                            <img src="{{ asset('findo/img/team/team3.jpg') }}" alt="Team">
                            <ul>
                                <li>
                                    <a href="#" target="_blank">
                                        <i class="icofont-facebook"></i>
