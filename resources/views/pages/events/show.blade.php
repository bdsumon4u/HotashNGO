                ...
                <div class="col-lg-8">
                    <div class="details-item">
                        <div class="details-img">
                            <img src="{{ asset('findo/img/event/event-details1.jpg') }}" alt="Details">
                            ...
                            <div class="row m-0">
                                <div class="col-4 col-sm-3 col-lg-4 p-0">
                                    <div class="instagram-item">
                                        <img src="{{ asset('findo/img/blog/instagram1.jpg') }}" alt="Instagram">
                                        <a href="#">
                                ...
                                <div class="col-4 col-sm-3 col-lg-4 p-0">
                                    <div class="instagram-item">
                                        <img src="{{ asset('findo/img/blog/instagram2.jpg') }}" alt="Instagram">
                                        <a href="#">
                                            <i class="icofont-instagram"></i>
                                        </a>
                                    </div>
                                ...
                                <div class="col-4 col-sm-3 col-lg-4 p-0">
                                    <div class="instagram-item">
                                        <img src="{{ asset('findo/img/blog/instagram3.jpg') }}" alt="Instagram">
                                        <a href="#">
                                            <i class="icofont-instagram"></i>
                                        </a>
                                    </div>
                                ...
                                <div class="col-4 col-sm-3 col-lg-4 p-0">
                                    <div class="instagram-item">
                                        <img src="{{ asset('findo/img/blog/instagram4.jpg') }}" alt="Instagram">
                                        <a href="#">
                                            <i class="icofont-instagram"></i>
                                        </a>
                                    </div>
                                ...
                                <div class="col-4 col-sm-3 col-lg-4 p-0">
                                    <div class="instagram-item">
                                        <img src="{{ asset('findo/img/blog/instagram5.jpg') }}" alt="Instagram">
                                        <a href="#">
                                            <i class="icofont-instagram"></i>
                                        </a>
                                    </div>
                                ...
                                <div class="col-4 col-sm-3 col-lg-4 p-0">
                                    <div class="instagram-item">
                                        <img src="{{ asset('findo/img/blog/instagram6.jpg') }}" alt="Instagram">
                                        <a href="#">
                                            <i class="icofont-instagram"></i>
                                        </a>
                                    </div>
