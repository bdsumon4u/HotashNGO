            ...
            <nav class="navbar navbar-expand-md navbar-light">
                ...
                <div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a href="about.html" class="nav-link">{{ __('About Us') }}</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a href="#" class="nav-link dropdown-toggle">{{ __('Events') }} <i class="icofont-simple-down"></i></a>
                            <ul class="dropdown-menu">
                                <li class="nav-item">
...
<div class="about-area pt-100 pb-70">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6">
                <div class="about-img">
                    <img src="https://templates.hibootstrap.com/findo/default/assets/img/about/about-main1.jpg" alt="About">
                </div>
            </div>
            <div class="col-lg-6">
        ...
        <div class="row">
            <div class="col-sm-6 col-lg-4">
                <div class="donation-item">
                    ...
                    <div class="img">
                        <img src="https://templates.hibootstrap.com/findo/default/assets/img/donation/donation1.jpg" alt="Donation">
            ...
            <div class="col-sm-6 col-lg-4">
                <div class="donation-item">
                    ...
                    <div class="img">
                        <img src="https://templates.hibootstrap.com/findo/default/assets/img/donation/donation2.jpg" alt="Donation">
                        <a class="common-btn" href="donation-details.html">Donate Now</a>
                    </div>
                    <div class="inner">
                        <div class="bottom">
            ...
            <div class="col-sm-6 col-lg-4">
                <div class="donation-item">
                    ...
                    <div class="img">
                        <img src="https://templates.hibootstrap.com/findo/default/assets/img/donation/donation3.jpg" alt="Donation">
                        <a class="common-btn" href="donation-details.html">Donate Now</a>
                    </div>
                    <div class="inner">
                        <div class="bottom">
            ...
            <div class="col-sm-6 col-lg-4">
                <div class="donation-item">
                    ...
                    <div class="img">
                        <img src="https://templates.hibootstrap.com/findo/default/assets/img/donation/donation4.jpg" alt="Donation">
                        <a class="common-btn" href="donation-details.html">Donate Now</a>
                    </div>
                    <div class="inner">
                        <div class="bottom">
            ...
            <div class="col-sm-6 col-lg-4">
                <div class="donation-item">
                    ...
                    <div class="img">
                        <img src="https://templates.hibootstrap.com/findo/default/assets/img/donation/donation5.jpg" alt="Donation">
                        <a class="common-btn" href="donation-details.html">Donate Now</a>
                    </div>
                    <div class="inner">
                        <div class="bottom">
            ...
            <div class="col-sm-6 col-lg-4">
                <div class="donation-item">
                    ...
                    <div class="img">
                        <img src="https://templates.hibootstrap.com/findo/default/assets/img/donation/donation6.jpg" alt="Donation">
                        <a class="common-btn" href="donation-details.html">Donate Now</a>
                    </div>
                    <div class="inner">
                        <div class="bottom">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-6 col-lg-4">
                <div class="team-item">
                    <div class="top">
                        <img src="https://templates.hibootstrap.com/findo/default/assets/img/team/team1.jpg" alt="Team">
                        <ul>
                            <li>
                                <a href="#" target="_blank">
                                    <i class="icofont-facebook"></i>
            ...
            <div class="col-sm-6 col-lg-4">
                <div class="team-item">
                    <div class="top">
                        <img src="https://templates.hibootstrap.com/findo/default/assets/img/team/team2.jpg" alt="Team">
                        <ul>
                            <li>
                                <a href="#" target="_blank">
                                    <i class="icofont-facebook"></i>
            ...
            <div class="col-sm-6 offset-sm-3 offset-lg-0 col-lg-4">
                <div class="team-item">
                    <div class="top">
                        <img src="https://templates.hibootstrap.com/findo/default/assets/img/team/team3.jpg" alt="Team">
                        <ul>
                            <li>
                                <a href="#" target="_blank">
                                    <i class="icofont-facebook"></i>
    ...
    <div class="container">
        ...
        <div class="testimonial-slider owl-theme owl-carousel">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="testimonial-img">
                        <img src="https://templates.hibootstrap.com/findo/default/assets/img/testimonial/testimonial1.jpg" alt="Testimonial">
                        <h3>Jac Jacson</h3>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="testimonial-img">
                        <img src="https://templates.hibootstrap.com/findo/default/assets/img/testimonial/testimonial2.jpg" alt="Testimonial">
                        <h3>Tom Henry</h3>
                        <span>Manager</span>
                    </div>
                </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="testimonial-img">
                        <img src="https://templates.hibootstrap.com/findo/default/assets/img/testimonial/testimonial3.jpg" alt="Testimonial">
                        <h3>Micheal Shon</h3>
                        <span>Director</span>
                    </div>
                </div>
        ...
        <div class="row">
                ...
                <div class="blog-item">
                    <div class="top">
                        <a href="blog-details.html">
                            <img src="https://templates.hibootstrap.com/findo/default/assets/img/blog/blog1.jpg" alt="Blog">
                        </a>
                    </div>
                    <div class="bottom">
                        <ul>
            ...
            <div class="col-sm-6 col-lg-4">
                <div class="blog-item">
                    <div class="top">
                        <a href="blog-details.html">
                            <img src="https://templates.hibootstrap.com/findo/default/assets/img/blog/blog2.jpg" alt="Blog">
                        </a>
                    </div>
                    <div class="bottom">
                        <ul>
            ...
            <div class="col-sm-6 offset-sm-3 offset-lg-0 col-lg-4">
                <div class="blog-item">
                    <div class="top">
                        <a href="blog-details.html">
                            <img src="https://templates.hibootstrap.com/findo/default/assets/img/blog/blog3.jpg" alt="Blog">
                        </a>
                    </div>
                    <div class="bottom">
                        <ul>
