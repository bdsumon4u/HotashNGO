<div x-data="{ lang: '{{ app()->getLocale() }}' }">
    ...
    <x:form action="" method="POST" multipart>
        ...
        <div x-show="lang === '{{ $lang }}'" class="flex flex-wrap md:-mx-2">
            <div class="pt-7 pb-2 px-2 bg-white border shadow-md relative rounded-md w-full mt-5">
                ...
                <x:textarea tinymce rows="6" name="description_{{ $lang }}" wire:model.defer="description_{{ $lang }}" class="block w-full px-2 py-1 border rounded-md text-gray-700 bg-gray-100 appearance-none focus:outline-none focus:bg-gray-200 focus:shadow-inner" />
