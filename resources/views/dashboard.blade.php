    ...
    <div class="w-full">
        <div class="px-5 py-10">
            <div class="grid grid-cols-1 gap-20 lg:grid-cols-2 lg:gap-40">
                <div class="flex items-center flex-wrap w-md px-10 bg-white shadow-xl rounded-2xl h-20" x-data="{ circumference: 50 * 2 * Math.PI, percent: {{ cache('cache_size', 80) }} }">
                    ...
                    <p class="ml-10 font-medium text-gray-600 sm:text-xl">Cache</p>

                    <span class="ml-auto text-xl font-medium" :class="{'text-blue-600': percent < 90, 'text-red-600': percent >= 90}">
                ...
                <div class="flex items-center flex-wrap w-md px-10 bg-white shadow-xl rounded-2xl h-20" x-data="{ circumference: 50 * 2 * Math.PI, percent: {{ cache('app_size', 90) }} }">
                    <div class="flex items-center justify-center -m-6 overflow-hidden bg-white relative rounded-full">
                        <svg class="w-32 h-32 transform translate-x-1 translate-y-1" aria-hidden="true">
                            <circle class="text-gray-300" stroke-width="10" stroke="currentColor" fill="transparent" r="50" cx="60" cy="60"></circle>
                    ...
                    <span class="ml-auto text-xl font-medium" :class="{'text-blue-600': percent < 90, 'text-red-600': percent >= 90}">{{ config('app.size') }}MB</span>
                </div>
            </div>
        </div>
            ...
            <table class="min-w-max w-full table-auto">
                ...
                <tr class="border-b border-gray-200 hover:bg-gray-100">
                    ...
                    <td class="py-3 px-6 text-left">
                        <div class="flex items-center">
                            <div class="mr-2">
                                <img class="w-6 h-6 rounded-md" src="https://randomuser.me/api/portraits/men/1.jpg">
                            </div>
                    ...
                    <td class="py-3 px-6 text-center">
                        <div class="flex items-center justify-center">
                            <img class="w-6 h-6 rounded-md border-gray-200 border transform hover:scale-125" src="https://randomuser.me/api/portraits/men/1.jpg">
                            <img class="w-6 h-6 rounded-md border-gray-200 border -m-1 transform hover:scale-125" src="https://randomuser.me/api/portraits/women/2.jpg">
                            <img class="w-6 h-6 rounded-md border-gray-200 border -m-1 transform hover:scale-125" src="https://randomuser.me/api/portraits/men/3.jpg">
                        </div>
                    </td>
                    <td class="py-3 px-6 text-center">
                        <span class="bg-purple-200 text-purple-600 py-1 px-3 rounded-md text-xs">Active</span>
                    </td>
                    <td class="py-3 px-6 text-center">
                ...
                <tr class="border-b border-gray-200 bg-gray-50 hover:bg-gray-100">
                    ...
                    <td class="py-3 px-6 text-left">
                        <div class="flex items-center">
                            <div class="mr-2">
                                <img class="w-6 h-6 rounded-md" src="https://randomuser.me/api/portraits/women/2.jpg">
                            </div>
                    ...
                    <td class="py-3 px-6 text-center">
                        <span class="bg-green-200 text-green-600 py-1 px-3 rounded-md text-xs">Completed</span>
                    </td>
                    <td class="py-3 px-6 text-center">
                        <div class="flex item-center justify-center">
                            <div class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                ...
                <tr class="border-b border-gray-200 hover:bg-gray-100">
                    ...
                    <td class="py-3 px-6 text-left">
                        <div class="flex items-center">
                            <div class="mr-2">
                                <img class="w-6 h-6 rounded-md" src="https://randomuser.me/api/portraits/men/3.jpg">
                            </div>
                    ...
                    <td class="py-3 px-6 text-center">
                        <span class="bg-yellow-200 text-yellow-600 py-1 px-3 rounded-md text-xs">Scheduled</span>
                    </td>
                    <td class="py-3 px-6 text-center">
                        <div class="flex item-center justify-center">
                            <div class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                ...
                <tr class="border-b border-gray-200 bg-gray-50 hover:bg-gray-100">
                    ...
                    <td class="py-3 px-6 text-left">
                        <div class="flex items-center">
                            <div class="mr-2">
                                <img class="w-6 h-6 rounded-md" src="https://randomuser.me/api/portraits/men/4.jpg">
                            </div>
                    ...
                    <td class="py-3 px-6 text-center">
                        <span class="bg-red-200 text-red-600 py-1 px-3 rounded-md text-xs">Pending</span>
                    </td>
                    <td class="py-3 px-6 text-center">
                        <div class="flex item-center justify-center">
                            <div class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                ...
                <tr class="border-b border-gray-200 hover:bg-gray-100">
                    ...
                    <td class="py-3 px-6 text-left">
                        <div class="flex items-center">
                            <div class="mr-2">
                                <img class="w-6 h-6 rounded-md" src="https://randomuser.me/api/portraits/men/5.jpg">
                            </div>
                ...
                <tr class="border-b border-gray-200 bg-gray-50 hover:bg-gray-100">
                    ...
                    <td class="py-3 px-6 text-left">
                        <div class="flex items-center">
                            <div class="mr-2">
                                <img class="w-6 h-6 rounded-md" src="https://randomuser.me/api/portraits/women/6.jpg">
                            </div>
                ...
                <tr class="border-b border-gray-200 hover:bg-gray-100">
                    ...
                    <td class="py-3 px-6 text-left">
                        <div class="flex items-center">
                            <div class="mr-2">
                                <img class="w-6 h-6 rounded-md" src="https://randomuser.me/api/portraits/women/7.jpg">
                            </div>
                            <span>Cora Key</span>
                        </div>
                    </td>
                ...
                <tr class="border-b border-gray-200 bg-gray-50 hover:bg-gray-100">
                    ...
                    <td class="py-3 px-6 text-left">
                        <div class="flex items-center">
                            <div class="mr-2">
                                <img class="w-6 h-6 rounded-md" src="https://randomuser.me/api/portraits/men/8.jpg">
                            </div>
